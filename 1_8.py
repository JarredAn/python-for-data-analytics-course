...
# Calculate the amount cthat Joe paid for the stock, not including the commission
...
#Calculate the total amount that Joe paid, which is the amount he paid for the stock plus the comission
# he paid his broker
...
# Calculate the amount of profit or loss. If this amount is a positive number, then Joe made a profit.
# If this is a negative number, it is a loss.
...
print(f'Profit (or loss if negataive): ${profitOrLoss:,.2f}')
